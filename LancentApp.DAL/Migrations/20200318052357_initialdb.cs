        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_AspNetUsers_AddedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferringPhysician = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requisitions_PatientProfiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentBy = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalValueId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tests_NormalRanges_NormalValueId",
                        column: x => x.NormalValueId,
                        principalTable: "NormalRanges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tests_Requisitions_RequisitionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("24fa5779-6884-483b-b7b9-becb25f4fbb3"), "ZA", "South Africa" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requisitions_ProfileId",
                table: "Requisitions",
                column: "ProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Tests_NormalValueId",
                table: "Tests",
                column: "NormalValueId");

            migrationBuilder.CreateIndex(
                name: "IX_Tests_RequisitionId",
                table: "Tests",
