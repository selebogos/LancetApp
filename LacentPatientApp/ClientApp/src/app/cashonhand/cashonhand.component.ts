...
@Component({
  selector: 'app-cashonhand',
  templateUrl: './cashonhand.component.html',
  styleUrls: ['./cashonhand.component.css']
})
export class CashonhandComponent implements OnInit {
  ...
  onSave() {
    ...
    try {
      ...
      this.posService.addCashOnHand(details.Amount1,details.Amount2,details.Amount3,details.Amount4,details.Amount5,
        details.Amount6,details.Amount7,details.Note,details.Branch).subscribe(result => {
