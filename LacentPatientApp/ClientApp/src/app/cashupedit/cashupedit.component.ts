...
@Component({
  selector: 'app-cashupedit',
  templateUrl: './cashupedit.component.html',
  styleUrls: ['./cashupedit.component.css']
})
export class CashupeditComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   this.posService.getCashupDetails(this.id).subscribe(
    ...
    data => {
      ...
      this.Amount1.setValue(this.POS.amount1);
  ...
  onSave() {
    ...
    try {
      ...
      this.posService.updateCashup(details.Amount1,details.Amount2,details.Amount3,details.Amount4,details.Amount5,details.Amount6,details.Amount7,details.Amount8,details.Note,this.id).subscribe(result => {
